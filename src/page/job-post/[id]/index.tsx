...
const JobPostDetail = () => {
  ...
  const updateJobPost = useMutation({
    mutationFn: (data: CreateJobPostInput) =>
      jobPostApi.updateJobPost(Number(jobPostId), data),
    onSuccess: () => {
        ...
        >
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  defaultChecked={jobPost.salaryNegotiable}
                  disabled={!isEditing}
                />
              }
              label="급여 협의 가능"
            ...
            <Box display="flex" flexDirection="column" gap={1}>
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={jobPost.forKindergarten}
                    disabled={!isEditing}
                  />
                }
                label="유아 대상"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={jobPost.forElementary}
                    disabled={!isEditing}
                  />
                }
                label="초등학생 대상"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={jobPost.forMiddleSchool}
                    disabled={!isEditing}
                  />
                }
                label="중학생 대상"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={jobPost.forHighSchool}
                    disabled={!isEditing}
                  />
                }
                label="고등학생 대상"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    {...register('forAdult')}
                    defaultChecked={jobPost.forAdult}
                    disabled={!isEditing}
                  />
                }
                label="성인 대상"
          ...
          <Box display="flex" gap={2} mt={2}>
            ...
            <Button
              type="submit"
              variant="contained"
              disabled={updateJobPost.isPending || !isEditing}
            >
